...
public class PrincipalF
{
	...
	private void Error(int pos,String cad)	
	{
		...
		if(entrada.get(pos)=="null0")
		{
			...
			if(entrada.get(pos)=="null1")
			{
				...
				{
					textoErrores += (entrada.get(pos)=="$"?"Se debe continuar la expresion":"\nError en el elemento: "+entraUser.get(pos)+"\n");
					textoErrores += ("Se esperaba: ");
	...
	public void Accion (LinkedList<String>pila)
	{
		...
		while(!pila.getFirst().equals("Q"))
		{
			...
			if(x<estados.length && y<columnas.length)//////Tabla sintactica
			{
				...
				this.mostrarPila(pilaT);//////Tabla sintactica
				...
				if(!tablaSint[x][y].isBlank())//////Tabla sintactica
				{
					...
					}else
					{
						if(tablaSint[x][y].charAt(0)=='P')//////Tabla sintactica
						{
							...
							{
								textoPila += "// CADENA ACEPTADA! //"; //->Resultado"
								codInter.Mostrar();
								obd.Println("///////////////////////////////////////////////");
								codInter.Datos(datos);
								this.mostrarCodigoInter(codInter.Convertir());
	...
	public void mostrarCodigoInter(LinkedList<String> pila)
	{
        ...
        public void mostrarPila(LinkedList<String> pila)
	{
		for(int x = 0; x<pila.size();x++)
        ...
        public void mostrarTokens(LinkedList<String> pila)
	{
		for(int x = 0; x<pila.size();x++)
	...
	/*public static void main(String[] args)
	{
		...
		/*obp.Accion(obp.Entrada(obp.Separar("Programa name { int var , id2 ; float f ; var = ( 5 * 4 ) + ( 2 * 4 ) ; id2 = read ; switch [ var ] "
				+ "{ case 1 : var = 'X' ; break case 2 : var = 'Y' ; break  Default : var = 'Z' ; break } "
				+ "while [ id2 >= 4.01 ] { id2 = id2 + 1 ; } }")));*/
		/*obp.Accion(obp.Entrada(obp.Separar("Programa name { int var , id2 ; float f ; f = 1 + 1 / ( 5 * 10 - 1 ) ; id2 = read ; print [ ~Hola~ + var ] ; switch [ var ] "
				+ "{ case 1 : var = 'X' ; break case 2 : var = 'y' ; break  Default : var = 'Y' ; break } "
				+ "while [ id2 >= 5.01 ] { id2 = id2 + 1 ; } }")));*/
		/*obp.Accion(obp.Entrada(obp.Separar("Programa name { int var , var2 ; float f1 ;  var = 3 + 10 * 5 ; f1 = read ; print [ ~Hola~ + var ] ; switch [ var ]"
				+ " { case 1 : var = ( 4 * 5 ) ; break case 2 : var = 'Y' ; break Default : var = 'Z' ; break } while [ var == 1 ] { while [ var == 1 ] { var = var + 1 ; }  } while [ var == 1 ] { var = var + 1 ; }  }")));*/
		
		/*obp.Accion(obp.Entrada(obp.Separar("Programa name { int a ; float var , var2 ; var = ( 5 * 4 ) + ( 2 * 4 ) ; var2 = read ; print [ ~hola~ ] ; "
				+ " switch [ a ] { case 1 : var = 'X' ;  break Default : var = 'Y' ; break } }")));*/
		
		/*obp.Accion(obp.Entrada(obp.Separar("Programa name { int a ; float var , var2 ; var =  ( 5 * 4 ) + ( 2 * 4 ) ; a = read ; print [ ~Hola~ + var ] ;"
				+ " switch [ a ] { case 1 : var = 'X' ; break case 2 : var = 'Y' ; break  Default : var = 'Z' ; break } }")));*/
		
		/*obp.Accion(obp.Entrada(obp.Separar("Programa name { int a ; float var , var2 ; var =  ( 5 * 4 ) + ( 2 * 4 ) ; a = read ; print [ ~Hola~ + var ] ;"
		+ " switch [ a ] { case 1 : var = 'X' ; break case 2 : var = 'Y' ; break  Default : var = 'Z' ; break }  }")));*/
		
		//obp.Accion(obp.Entrada(obp.Separar("Programa name { int a ; a = a + 1 ; while [ a <= 1 ] { a = a + 1 ; } }")));		                
               	//}
}
